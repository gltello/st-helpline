...
def home_page():
    ...
    st.markdown('STEP 2: There are 10 questions to be answered from different areas of interest, each question has 6 possible answers, each response is ranked from 0 to 5, being 0 the best and 5 the worst.')
    st.markdown('STEP 3: Hit the submit button, you will get a final score from 0 to 10, being 0 the worst and 10 the best.')
